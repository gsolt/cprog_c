...
sT[0].sCP[0].sCPR[20].nDCStart = 75;   		sT[0].sCP[0].sCPR[20].nDCNum = 1;       sT[0].sCP[0].sCPR[20].nSCStart= 76;         sT[0].sCP[0].sCPR[20].nAckStart=0;	 	sT[0].sCP[0].sCPR[20].nAckNum=0;      sT[0].sCP[0].sCPR[20].nSPOffsetCS = 210;        sT[0].sCP[0].sCPR[20].nSPOffsetLek = 211;
...
sT[0].sCP[0].sCPR[111].nDCStart= 409; 		sT[0].sCP[0].sCPR[111].nDCNum =1;   	  sT[0].sCP[0].sCPR[111].nSCStart=413;  		  sT[0].sCP[0].sCPR[111].nAckStart=0;  	sT[0].sCP[0].sCPR[111].nAckNum=0; 	  sT[0].sCP[0].sCPR[111].nSPOffsetCS= 2126; 	    sT[0].sCP[0].sCPR[111].nSPOffsetLek= 2127; 
...
sT[0].sCP[0].sCPR[115].nDCStart=1243;  		sT[0].sCP[0].sCPR[115].nDCNum =6;       sT[0].sCP[0].sCPR[115].nSCStart=1249;       sT[0].sCP[0].sCPR[115].nAckStart=0;  	sT[0].sCP[0].sCPR[115].nAckNum=0;     sT[0].sCP[0].sCPR[115].nSPOffsetCS= 5720;       sT[0].sCP[0].sCPR[115].nSPOffsetLek= 5721;
...
sT[0].sTI[7].nType = TYP_TMOK;
	...
	sT[0].sMOT[7].nIEC_NM				= 1671;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[7].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[7].nIEC_NM2				  = 1675;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[7].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[9].nType = TYP_TMOK;
	...
	sT[0].sMOT[9].nIEC_NM				= 1725;		/* Mérések IEC kezdõcíme */

	sT[0].sMOT[9].nNMNum				= 4;		/* Analóg mérések száma*/
	sT[0].sMOT[9].nIEC_NM2			= 1729;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[9].nNMNum2				= 2;		/* Analóg mérések száma*/
...
sT[0].sTI[13].nType = TYP_TMOK;
	...
	sT[0].sMOT[13].nIEC_NM				= 1551;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[13].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[13].nIEC_NM2				  = 1555;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[13].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[14].nType = TYP_TMOK;
	...
	sT[0].sMOT[14].nIEC_NM				= 1563;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[14].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[14].nIEC_NM2				  = 1567;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[14].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[15].nType = TYP_TMOK;
	...
	sT[0].sMOT[15].nIEC_NM				= 1557;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[15].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[15].nIEC_NM2				  = 1561;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[15].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[17].nType = TYP_TMOK;
	...
	sT[0].sMOT[17].nIEC_NM				= 1837;		/* Mérések IEC kezdõcíme */
  sT[0].sMOT[17].nNMNum     		= 4;		/* Mérések száma */
/* 34-84 PM6 TMOK -----------------------------------------------------------*/
sT[0].sTI[18].nType = TYP_TMOK;
	...
	sT[0].sMOT[18].nIEC_NM				= 1841;		/* Mérések IEC kezdõcíme */
  sT[0].sMOT[18].nNMNum     		= 4;		/* Mérések száma */
/* 86-81 TMOK -----------------------------------------------------------*/
sT[0].sTI[19].nType = TYP_TMOK;
	...
	sT[0].sMOT[19].nIEC_NM				= 877;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[19].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[19].nIEC_NM2				  = 881;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[19].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[20].nType = TYP_TMOK;
	...
	sT[0].sMOT[20].nIEC_NM				= 204;		/* Mérések IEC kezdõcíme */
  sT[0].sMOT[20].nNMNum     			= 4;		/* Mérések száma */
...
sT[0].sTI[23].nType = TYP_TMOK;
	...
	sT[0].sMOT[23].nIEC_NM				= 1647;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[23].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[23].nIEC_NM2				  = 1651;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[23].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[25].nType = TYP_TMOK;
	...
	sT[0].sMOT[25].nIEC_NM2				  = 1531;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[25].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[26].nType = TYP_TMOK;
	...
	sT[0].sMOT[26].nIEC_NM2				  = 36;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[26].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[27].nType = TYP_TMOK;
	...
	sT[0].sMOT[27].nIEC_NM2				  = 1493;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[27].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[28].nType = TYP_TMOK;
	...
	sT[0].sMOT[28].nIEC_NM2				  = 1797;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[28].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[30].nType = TYP_TMOK;
	...
	sT[0].sMOT[30].nIEC_NM				= 1445;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[30].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[30].nIEC_NM2				  = 1449;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[30].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[39].nType = TYP_TMOK;
	...
	sT[0].sMOT[39].nIEC_NM				= 1851;		/* Mérések IEC kezdõcíme */
  sT[0].sMOT[39].nNMNum     		= 4;		/* Mérések száma */
...
sT[0].sTI[41].nType = TYP_TMOK;
	...
	sT[0].sMOT[41].nIEC_NM				= 1879;		/* Mérések IEC kezdõcíme */
  sT[0].sMOT[41].nNMNum     		= 4;		/* Mérések száma */  
...
sT[0].sTI[43].nType = TYP_TMOK;
	...
	sT[0].sMOT[43].nIEC_NM				= 1981;		/* Mérések IEC kezdõcíme */

	sT[0].sMOT[43].nNMNum      			= 4;
	sT[0].sMOT[43].nIEC_NM2				= 1985;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[43].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[44].nType = TYP_TMOK;
	...
	sT[0].sMOT[44].nIEC_NM				= 1883;		/* Mérések IEC kezdõcíme */
  sT[0].sMOT[44].nNMNum     		= 4;		/* Mérések száma */  
...
sT[0].sTI[45].nType = TYP_TMOK;
	...
	sT[0].sMOT[45].nIEC_NM2				= 1749;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[45].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[46].nType = TYP_TMOK;
	...
	sT[0].sMOT[46].nIEC_NM				= 1887;		/* Mérések IEC kezdõcíme */
  sT[0].sMOT[46].nNMNum     		= 4;		/* Mérések száma */  
...
sT[0].sTI[47].nType = TYP_TMOK;
	...
	sT[0].sMOT[47].nIEC_NM				= 576;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[47].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[47].nIEC_NM2				= 580;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[47].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[49].nType = TYP_TMOK;
	...
	sT[0].sMOT[49].nIEC_NM2				= 1751;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[49].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[50].nType = TYP_TMOK;
	...
	sT[0].sMOT[50].nIEC_NM2				= 1795;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[50].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[56].nType = TYP_TMOK;
	...
	sT[0].sMOT[56].nIEC_NM				= 433;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[56].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[56].nIEC_NM2				= 437;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[56].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[57].nType = TYP_TMOK;
	...
	sT[0].sMOT[57].nIEC_NM2				= 1042;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[57].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[61].nType = TYP_TMOK;
	...
	sT[0].sMOT[61].nIEC_NM				= 1819;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[61].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[61].nIEC_NM2				  = 1823;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[61].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[65].nType = TYP_TMOK;
	...
	sT[0].sMOT[65].nIEC_NM				= 263;		/* Mérések IEC kezdõcíme */

	sT[0].sMOT[65].nNMNum      			= 4;
	sT[0].sMOT[65].nIEC_NM2				  = 267;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[65].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[82].nType = TYP_TMOK;
	...
	sT[0].sMOT[82].nIEC_NM				= 87;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[82].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[82].nIEC_NM2				  = 91;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[82].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[93].nType = TYP_TMOK;
	...
	sT[0].sMOT[93].nIEC_NM				= 114;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[93].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[93].nIEC_NM2				  = 118;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[93].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[100].nType = TYP_TMOK;
	...
	sT[0].sMOT[100].nIEC_NM				= 1929;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[100].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[100].nIEC_NM2				= 1933;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[100].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[108].nType = TYP_MOT;	
	...
	sT[0].sMOT[108].nIEC_NM				= 1617;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[108].nNMNum				= 6;		/* Analóg mérések száma*/
...
/* 36-10 PM6 (21-34, 21-38 NPS-RTU-NPS) TMOK ----------------------------------------------------*/
sT[0].sTI[111].nType = TYP_TMOK;
	...
	sT[0].sMOT[111].nIEC_NM				= 1963;		/* Mérések IEC kezdõcíme */

	sT[0].sMOT[111].nNMNum				= 4;		/* Analóg mérések száma*/
	sT[0].sMOT[111].nIEC_NM2				= 1967;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[111].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[115].nType = TYP_MOT;	
	...
	sT[0].sMOT[115].nIEC_SP				= 5700;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[115].nIEC_SP_NUM			= 20;		/* Egybites értékek száma*/
	sT[0].sMOT[115].nIEC_DP				= 863;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[115].nIEC_DP_NUM			=12;   		/* Két bites értékek száma*/
	sT[0].sMOT[115].nIEC_NM				= 1599;		/* Mérések IEC kezdõcíme */
	sT[0].sMOT[115].nNMNum				= 12;		/* Analóg mérések száma*/

/* Oroszlány, Gimnázium ---------------------------------------------------------------*/
sT[0].sTI[116].nType = TYP_MOT;	
	
	sT[0].sMOT[116].nIEC_SP				= 2210;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[116].nIEC_SP_NUM			= 20;		/* Egybites értékek száma*/
...
sT[0].sTI[118].nType = TYP_TMOK;
	...
	sT[0].sMOT[118].nIEC_NM				= 1501;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[118].nNMNum     			= 4;		/* Mérések száma */
...
sT[0].sTI[121].nType = TYP_TMOK;
	...
	sT[0].sMOT[121].nIEC_NM				= 1771;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[121].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[121].nIEC_NM2				= 1775;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[121].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[122].nType = TYP_TMOK;
	...
	sT[0].sMOT[122].nIEC_NM				= 1539;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[122].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[122].nIEC_NM2				= 1543;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[122].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[123].nType = TYP_TMOK;
	...
	sT[0].sMOT[123].nIEC_NM				= 1525;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[123].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[123].nIEC_NM2				= 1529;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[123].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[124].nType = TYP_TMOK;
	...
	sT[0].sMOT[124].nIEC_NM				= 1575;		/* Mérések IEC kezdõcíme */
	
  sT[0].sMOT[124].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[124].nIEC_NM2				= 1579;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[124].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[125].nType = TYP_TMOK;
	...
	sT[0].sMOT[125].nIEC_NM				= 1957;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[125].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[125].nIEC_NM2				= 1961;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[125].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[126].nType = TYP_TMOK;
	...
	sT[0].sMOT[126].nIEC_NM				= 1941;		/* Mérések IEC kezdõcíme */
  sT[0].sMOT[126].nNMNum     			= 4;		/* Mérések száma */  
/*  41-23 OK2  -----------------------------------------------------------*/
sT[0].sTI[127].nType = TYP_TMOK;
	...
	sT[0].sMOT[127].nIEC_NM				= 585;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[127].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[127].nIEC_NM2				= 589;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[127].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[128].nType = TYP_TMOK;
	...
	sT[0].sMOT[128].nIEC_NM				= 210;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[128].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[128].nIEC_NM2				= 214;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[128].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[129].nType = TYP_TMOK;
	...
	sT[0].sMOT[129].nIEC_NM				= 159;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[129].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[129].nIEC_NM2				= 163;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[129].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[130].nType = TYP_TMOK;
	...
	sT[0].sMOT[130].nIEC_NM				= 1433;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[130].nNMNum     			= 4;		/* Mérések száma */
...
sT[0].sTI[133].nType = TYP_TMOK;
	...
	sT[0].sMOT[133].nIEC_NM				= 1593;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[133].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[133].nIEC_NM2				= 1597;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[133].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[142].nType = TYP_TMOK;
	...
	sT[0].sMOT[142].nIEC_NM				= 1629;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[142].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[142].nIEC_NM2				= 1633;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[142].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[143].nType = TYP_TMOK;
	...
	sT[0].sMOT[143].nIEC_NM				= 415;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[143].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[143].nIEC_NM2				= 419;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[143].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[144].nType = TYP_TMOK;
	...
	sT[0].sMOT[144].nIEC_NM				= 889;		/* Mérések IEC kezdõcíme */
	
	  sT[0].sMOT[144].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[144].nIEC_NM2				= 893;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[144].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[150].nType = TYP_TMOK;
	...
	sT[0].sMOT[150].nIEC_NM				= 1653;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[150].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[150].nIEC_NM2				= 1657;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[150].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[152].nType = TYP_TMOK;
	...
	sT[0].sMOT[152].nIEC_NM				= 1701;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[152].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[152].nIEC_NM2				= 1705;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[152].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[158].nType = TYP_TMOK;
	...
	sT[0].sMOT[158].nIEC_NM				= 1707;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[158].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[158].nIEC_NM2				= 1711;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[158].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[160].nType = TYP_TMOK;
	...
	sT[0].sMOT[160].nIEC_NM				= 1495;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[160].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[160].nIEC_NM2				= 1499;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[160].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[161].nType = TYP_TMOK;
	...
	sT[0].sMOT[161].nIEC_NM				= 1519;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[161].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[161].nIEC_NM2				= 1523;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[161].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[167].nType = TYP_TMOK;
	...
	sT[0].sMOT[167].nIEC_NM				= 1831;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[167].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[167].nIEC_NM2				= 1835;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[167].nNMNum2				  = 2;		  /* Analóg mérések száma*/
...
sT[0].sTI[172].nType = TYP_TMOK;
	...
	sT[0].sMOT[172].nIEC_NM				= 1789;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[172].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[172].nIEC_NM2				= 1793;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[172].nNMNum2				  = 2;		  /* Analóg mérések száma*/
...
sT[0].sTI[174].nType = TYP_TMOK;
	...
	sT[0].sMOT[174].nIEC_NM				= 1813;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[174].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[174].nIEC_NM2				= 1817;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[174].nNMNum2				  = 2;		  /* Analóg mérések száma*/
...
sT[0].sTI[176].nType = TYP_TMOK;
	...
	sT[0].sMOT[176].nIEC_NM				= 1689;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[176].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[176].nIEC_NM2				= 1693;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[176].nNMNum2				  = 2;		  /* Analóg mérések száma*/
...
sT[0].sTI[177].nType = TYP_TMOK;
	...
	sT[0].sMOT[177].nIEC_NM				= 1891;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[177].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[177].nIEC_NM2				= 1895;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[177].nNMNum2				  = 2;		  /* Analóg mérések száma*/
...
sT[0].sTI[180].nType = TYP_TMOK;
	...
	sT[0].sMOT[180].nIEC_NM				= 706;		/* Mérések IEC kezdõcíme */
	
  sT[0].sMOT[180].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[180].nIEC_NM2				= 710;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[180].nNMNum2				  = 2;		  /* Analóg mérések száma*/
/*  42-29 OK2  -----------------------------------------------------------*/
...
sT[0].sTI[182].nType = TYP_TMOK;
	...
	sT[0].sMOT[182].nIEC_NM				= 186;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[182].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[182].nIEC_NM2				= 190;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[182].nNMNum2				  = 2;		  /* Analóg mérések száma*/
...
sT[0].sTI[183].nType = TYP_TMOK;
	...
	sT[0].sMOT[183].nIEC_NM				= 108;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[183].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[183].nIEC_NM2				= 112;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[183].nNMNum2				  = 2;		  /* Analóg mérések száma*/
...
sT[0].sTI[184].nType = TYP_TMOK;
	...
	sT[0].sMOT[184].nIEC_NM				= 1641;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[184].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[184].nIEC_NM2				= 1645;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[184].nNMNum2				  = 2;		  /* Analóg mérések száma*/
...
sT[0].sTI[185].nType = TYP_TMOK;
	...
	sT[0].sMOT[185].nIEC_NM				= 1861;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[185].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[185].nIEC_NM2				= 1865;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[185].nNMNum2				  = 2;		  /* Analóg mérések száma*/
...
sT[0].sTI[186].nType = TYP_TMOK;
	...
	sT[0].sMOT[186].nIEC_NM				= 1783;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[186].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[186].nIEC_NM2				= 1787;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[186].nNMNum2				  = 2;		  /* Analóg mérések száma*/
...
sT[0].sTI[187].nType = TYP_TMOK;
	...
	sT[0].sMOT[187].nIEC_NM				= 1451;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[187].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[187].nIEC_NM2				= 1455;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[187].nNMNum2				  = 2;		  /* Analóg mérések száma*/
...
sT[0].sTI[194].nType = TYP_TMOK;
	...
	sT[0].sMOT[194].nIEC_NM				= 1951;		/* Mérések IEC kezdõcíme */
	
  sT[0].sMOT[194].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[194].nIEC_NM2				= 1955;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[194].nNMNum2				  = 2;		  /* Analóg mérések száma*/
...
sT[0].sTI[200].nType = TYP_TMOK;
	...
	sT[0].sMOT[200].nIEC_NM				= 1569;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[200].nNMNum     			= 4;		  /* Mérések száma */
	sT[0].sMOT[200].nIEC_NM2				= 1573;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[200].nNMNum2				  = 2;		  /* Analóg mérések száma*/
...
sT[0].sTI[208].nType = TYP_TMOK;
	...
	sT[0].sMOT[208].nIEC_NM				= 1635;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[208].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[208].nIEC_NM2				  = 1639;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[208].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[211].nType = TYP_TMOK;
	...
	sT[0].sMOT[211].nIEC_NM				= 991;		/* Mérések IEC kezdõcíme */
	
  sT[0].sMOT[211].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[211].nIEC_NM2				= 995;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[211].nNMNum2				  = 2;		/* Analóg mérések száma*/
/*  37-29 OK2  -----------------------------------------------------------*/
...
sT[0].sTI[213].nType = TYP_TMOK;
	...
	sT[0].sMOT[213].nIEC_NM				= 1457;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[213].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[213].nIEC_NM2				= 1461;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[213].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[214].nType = TYP_TMOK;
	...
	sT[0].sMOT[214].nIEC_NM				= 93;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[214].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[214].nIEC_NM2				= 97;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[214].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[215].nType = TYP_TMOK;
	...
	sT[0].sMOT[215].nIEC_NM				= 400;		/* Mérések IEC kezdõcíme */
	
  sT[0].sMOT[215].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[215].nIEC_NM2				= 404;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[215].nNMNum2				  = 2;		/* Analóg mérések száma*/
/*  41-53 OK2  -----------------------------------------------------------*/
...
sT[0].sTI[219].nType = TYP_TMOK;
	...
	sT[0].sMOT[219].nIEC_NM				= 1935;		/* Mérések IEC kezdõcíme */
		sT[0].sMOT[219].nNMNum				= 4;		/* Analóg mérések száma*/
	sT[0].sMOT[219].nIEC_NM2				  = 1939;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[219].nNMNum2				  = 2;		/* Analóg mérések száma*/
/*  91-34 OK2  -----------------------------------------------------------*/
sT[0].sTI[220].nType = TYP_TMOK;
	...
	sT[0].sMOT[220].nIEC_NM				= 1713;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[220].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[220].nIEC_NM2				= 1717;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[220].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[221].nType = TYP_TMOK;
	...
	sT[0].sMOT[221].nIEC_NM				= 1945;		/* Mérések IEC kezdõcíme */
			sT[0].sMOT[221].nNMNum				= 4;		/* Analóg mérések száma*/
	sT[0].sMOT[221].nIEC_NM2				  = 1949;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[221].nNMNum2				  = 2;		/* Analóg mérések száma*/
/*  92-03 OK2  -----------------------------------------------------------*/
...
sT[0].sTI[224].nType = TYP_TMOK;
	...
	sT[0].sMOT[224].nIEC_NM				= 1777;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[224].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[224].nIEC_NM2				= 1781;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[224].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[228].nType = TYP_TMOK;
	...
	sT[0].sMOT[228].nIEC_NM				= 1545;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[228].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[228].nIEC_NM2				= 1549;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[228].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[236].nType = TYP_TMOK;
	...
	sT[0].sMOT[236].nIEC_NM				= 445;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[236].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[236].nIEC_NM2				= 449;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[236].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[237].nType = TYP_TMOK;
	...
	sT[0].sMOT[237].nIEC_NM				= 1765;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[237].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[237].nIEC_NM2				= 1769;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[237].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[238].nType = TYP_TMOK;
	...
	sT[0].sMOT[238].nIEC_NM				= 1903;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[238].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[238].nIEC_NM2				= 1907;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[238].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[243].nType = TYP_TMOK;
	...
	sT[0].sMOT[243].nIEC_NM				= 1987;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[243].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[243].nIEC_NM2				= 1991;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[243].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[244].nType = TYP_TMOK;
	...
	sT[0].sMOT[244].nIEC_NM				= 694;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[244].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[244].nIEC_NM2				= 698;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[244].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[245].nType = TYP_TMOK;
	...
	sT[0].sMOT[245].nIEC_NM				= 865;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[245].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[245].nIEC_NM2				= 869;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[245].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[248].nType = TYP_TMOK;
	...
	sT[0].sMOT[248].nIEC_NM				= 1737;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[248].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[248].nIEC_NM2				= 1741;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[248].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[250].nType = TYP_TMOK;
	...
	sT[0].sMOT[250].nIEC_NM				= 394;		/* Mérések IEC kezdõcíme */
	  
  sT[0].sMOT[250].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[250].nIEC_NM2				= 398;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[250].nNMNum2				  = 2;		/* Analóg mérések száma*/
/*  20-01   -----------------------------------------------------------*/
...
sT[0].sTI[253].nType = TYP_TMOK;
	...
	sT[0].sMOT[253].nIEC_NM				= 1855;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[253].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[253].nIEC_NM2				= 1859;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[253].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[254].nType = TYP_TMOK;
	...
	sT[0].sMOT[254].nIEC_NM				= 1481;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[254].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[254].nIEC_NM2				= 1485;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[254].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[255].nType = TYP_TMOK;
	...
	sT[0].sMOT[255].nIEC_NM				= 1463;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[255].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[255].nIEC_NM2				= 1467;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[255].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[256].nType = TYP_TMOK;
	...
	sT[0].sMOT[256].nIEC_NM				= 1469;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[256].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[256].nIEC_NM2				= 1473;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[256].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[260].nType = TYP_TMOK;
	...
	sT[0].sMOT[260].nIEC_NM				= 1439;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[260].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[260].nIEC_NM2				= 1443;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[260].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[266].nType = TYP_TMOK;
	...
	sT[0].sMOT[266].nIEC_NM				= 1371;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[266].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[266].nIEC_NM2				= 1375;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[266].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[269].nType = TYP_TMOK;
	...
	sT[0].sMOT[269].nIEC_NM				= 427;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[269].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[269].nIEC_NM2				= 431;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[269].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[270].nType = TYP_TMOK;
	...
	sT[0].sMOT[270].nIEC_NM				= 791;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[270].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[270].nIEC_NM2				= 795;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[270].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[275].nType = TYP_TMOK;
	...
	sT[0].sMOT[275].nIEC_NM				= 1513;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[275].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[275].nIEC_NM2				= 1517;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[275].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[276].nType = TYP_TMOK;
	...
	sT[0].sMOT[276].nIEC_NM				= 180;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[276].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[276].nIEC_NM2				= 184;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[276].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[277].nType = TYP_TMOK;
	...
	sT[0].sMOT[277].nIEC_NM				= 1475;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[277].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[277].nIEC_NM2				= 1479;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[277].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[278].nType = TYP_TMOK;
	...
	sT[0].sMOT[278].nIEC_NM				= 1507;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[278].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[278].nIEC_NM2				= 1511;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[278].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[279].nType = TYP_TMOK;
	...
	sT[0].sMOT[279].nIEC_NM				= 1665;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[279].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[279].nIEC_NM2				= 1669;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[279].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[282].nType = TYP_TMOK;
	...
	sT[0].sMOT[282].nIEC_NM				= 1683;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[282].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[282].nIEC_NM2				= 1687;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[282].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[283].nType = TYP_TMOK;
	...
	sT[0].sMOT[283].nIEC_NM				= 1695;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[283].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[283].nIEC_NM2				= 1699;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[283].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[284].nType = TYP_TMOK;
	...
	sT[0].sMOT[284].nIEC_NM				= 1677;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[284].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[284].nIEC_NM2				= 1681;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[284].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[286].nType = TYP_TMOK;
	...
	sT[0].sMOT[286].nIEC_NM				= 1923;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[286].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[286].nIEC_NM2				= 1927;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[286].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[306].nType = TYP_TMOK;
	...
	sT[0].sMOT[306].nIEC_NM				= 985;		/* Mérések IEC kezdõcíme */
  
	sT[0].sMOT[306].nNMNum     		= 4;		/* Mérések száma */
	sT[0].sMOT[306].nIEC_NM2			= 989;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[306].nNMNum2				= 2;		/* Analóg mérések száma*/
...
sT[0].sTI[307].nType = TYP_TMOK;
	...
	sT[0].sMOT[307].nIEC_NM				= 421;		/* Mérések IEC kezdõcíme */

	sT[0].sMOT[307].nNMNum     		= 4;		/* Mérések száma */
	sT[0].sMOT[307].nIEC_NM2			= 425;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[307].nNMNum2				= 2;		/* Analóg mérések száma*/
...
sT[0].sTI[310].nType = TYP_TMOK;
	...
	sT[0].sMOT[310].nIEC_NM				= 1799;		/* Mérések IEC kezdõcíme */
  
  sT[0].sMOT[310].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[310].nIEC_NM2				= 1803;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[310].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[312].nType = TYP_TMOK;
	...
	sT[0].sMOT[312].nIEC_NM				= 1611;		/* Mérések IEC kezdõcíme */
	
  sT[0].sMOT[312].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[312].nIEC_NM2				= 1615;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[312].nNMNum2				  = 2;		/* Analóg mérések száma*/
/*  80-98  -----------------------------------------------------------*/
...
sT[0].sTI[314].nType = TYP_TMOK;
	...
	sT[0].sMOT[314].nIEC_NM				= 1731;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[314].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[314].nIEC_NM2				= 1735;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[314].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[315].nType = TYP_TMOK;
	...
	sT[0].sMOT[315].nIEC_NM				= 1487;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[315].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[315].nIEC_NM2				= 1491;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[315].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[316].nType = TYP_TMOK;
	...
	sT[0].sMOT[316].nIEC_NM				= 1659;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[316].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[316].nIEC_NM2				= 1663;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[316].nNMNum2				  = 2;		/* Analóg mérések száma*/
...
sT[0].sTI[318].nType = TYP_TMOK;
	...
	sT[0].sMOT[318].nIEC_NM				= 1805;		/* Mérések IEC kezdõcíme */

  sT[0].sMOT[318].nNMNum     			= 4;		/* Mérések száma */
	sT[0].sMOT[318].nIEC_NM2				= 1809;		/* Mérések IEC kezdõcíme */	
	sT[0].sMOT[318].nNMNum2				  = 2;		/* Analóg mérések száma*/
