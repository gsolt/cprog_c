...
sT[0].sTI[3].nType = TYP_TMOK;
	...
	sT[0].sMOT[3].nIEC_NM				= 16;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[10].nType = TYP_TMOK;
	...
	sT[0].sMOT[10].nIEC_NM				= 34;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[12].nType = TYP_TMOK;
	...
	sT[0].sMOT[12].nIEC_NM				= 37;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[21].nType = TYP_TMOK;
	...
	sT[0].sMOT[21].nIEC_NM				= 78;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[22].nType = TYP_TMOK;
	...
	sT[0].sMOT[22].nIEC_NM				= 81;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[27].nType = TYP_TMOK;
	...
	sT[0].sMOT[27].nIEC_NM				= 96;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[28].nType = TYP_TMOK;
	...
	sT[0].sMOT[28].nIEC_NM				= 99;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[29].nType = TYP_TMOK;
	...
	sT[0].sMOT[29].nIEC_NM				= 102;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[31].nType = TYP_TMOK;
	...
	sT[0].sMOT[31].nIEC_NM				= 108;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[32].nType = TYP_TMOK;
	...
	sT[0].sMOT[32].nIEC_NM				= 111;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[33].nType = TYP_TMOK;
	...
	sT[0].sMOT[33].nIEC_NM				= 117;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[34].nType = TYP_TMOK;
	...
	sT[0].sMOT[34].nIEC_NM				= 120;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[38].nType = TYP_TMOK;
	...
	sT[0].sMOT[38].nIEC_NM				= 132;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[40].nType = TYP_TMOK;
	...
	sT[0].sMOT[40].nIEC_NM				= 114;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[42].nType = TYP_TMOK;
	...
	sT[0].sMOT[42].nIEC_NM				= 138;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[45].nType = TYP_TMOK;
	...
	sT[0].sMOT[45].nIEC_NM				= 147;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[49].nType = TYP_TMOK;
	...
	sT[0].sMOT[49].nIEC_NM				= 159;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[50].nType = TYP_TMOK;
	...
	sT[0].sMOT[50].nIEC_NM				= 162;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[51].nType = TYP_TMOK;
	...
	sT[0].sMOT[51].nIEC_NM				= 165;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[52].nType = TYP_TMOK;
	...
	sT[0].sMOT[52].nIEC_NM				= 168;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[53].nType = TYP_TMOK;
	...
	sT[0].sMOT[53].nIEC_NM				= 171;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[57].nType = TYP_TMOK;
	...
	sT[0].sMOT[57].nIEC_NM				= 183;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[58].nType = TYP_TMOK;
	...
	sT[0].sMOT[58].nIEC_NM				= 186;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[59].nType = TYP_TMOK;
	...
	sT[0].sMOT[59].nIEC_NM				= 189;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[60].nType = TYP_TMOK;
	...
	sT[0].sMOT[60].nIEC_NM				= 192;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[62].nType = TYP_TMOK;
	...
	sT[0].sMOT[62].nIEC_NM				= 198;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[63].nType = TYP_TMOK;
	...
	sT[0].sMOT[63].nIEC_NM				= 201;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[64].nType = TYP_TMOK;
	...
	sT[0].sMOT[64].nIEC_NM				= 204;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[66].nType = TYP_TMOK;
	...
	sT[0].sMOT[66].nIEC_NM				= 210;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[67].nType = TYP_TMOK;
	...
	sT[0].sMOT[67].nIEC_NM				= 213;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[68].nType = TYP_TMOK;
	...
	sT[0].sMOT[68].nIEC_NM				= 216;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[98].nType = TYP_MOT;	
	...
	sT[0].sMOT[98].nIEC_SP				= 1936;		/* Egybites értékek IEC kezdõcíme*/
	sT[0].sMOT[98].nIEC_SP_NUM			= 14;		/* Egybites értékek száma*/
	sT[0].sMOT[98].nIEC_DP				= 263;		/* Kétbites értékek IEC kezdõcíme*/
	sT[0].sMOT[98].nIEC_DP_NUM			= 8;   		/* Két bites értékek száma*/
	sT[0].sMOT[98].nIEC_NM				= 0;		/* Mérések IEC kezdõcíme */
...
sT[0].sTI[134].nType = TYP_TMOK;
	...
	sT[0].sMOT[134].nIEC_NM				= 415;		/* Mérések IEC kezdõcíme */
/*  30-26 OK2  -----------------------------------------------------------*/
sT[0].sTI[135].nType = TYP_TMOK;
	...
	sT[0].sMOT[135].nIEC_NM				= 418;		/* Mérések IEC kezdõcíme */
/*  30-79 OK2  -----------------------------------------------------------*/
sT[0].sTI[136].nType = TYP_TMOK;
	...
	sT[0].sMOT[136].nIEC_NM				= 421;		/* Mérések IEC kezdõcíme */
/*  30-93 OK2  -----------------------------------------------------------*/
sT[0].sTI[137].nType = TYP_TMOK;
	...
	sT[0].sMOT[137].nIEC_NM				= 424;		/* Mérések IEC kezdõcíme */
/*  31-96 OK2  -----------------------------------------------------------*/
sT[0].sTI[138].nType = TYP_TMOK;
	...
	sT[0].sMOT[138].nIEC_NM				= 427;		/* Mérések IEC kezdõcíme */
/*  32-19 OK2  -----------------------------------------------------------*/
sT[0].sTI[139].nType = TYP_TMOK;
	...
	sT[0].sMOT[139].nIEC_NM				= 430;		/* Mérések IEC kezdõcíme */
/*  32-14 OK2  -----------------------------------------------------------*/
sT[0].sTI[140].nType = TYP_TMOK;
	...
	sT[0].sMOT[140].nIEC_NM				= 433;		/* Mérések IEC kezdõcíme */
/*  32-27 OK2  -----------------------------------------------------------*/
sT[0].sTI[141].nType = TYP_TMOK;
	...
	sT[0].sMOT[141].nIEC_NM				= 436;		/* Mérések IEC kezdõcíme */
/*  34-11 OK2  -----------------------------------------------------------*/
...
sT[0].sTI[145].nType = TYP_TMOK;
	...
	sT[0].sMOT[145].nIEC_NM				= 448;		/* Mérések IEC kezdõcíme */
/*  12-37 OK2  -----------------------------------------------------------*/
...
sT[0].sTI[154].nType = TYP_TMOK;
	...
	sT[0].sMOT[154].nIEC_NM				= 475;		/* Mérések IEC kezdõcíme */
/*  81-62 OK2  -----------------------------------------------------------*/
...
sT[0].sTI[162].nType = TYP_TMOK;
	...
	sT[0].sMOT[162].nIEC_NM				= 502;		/* Mérések IEC kezdõcíme */
/*  91-03 OK2  -----------------------------------------------------------*/
...
sT[0].sTI[179].nType = TYP_TMOK;
	...
	sT[0].sMOT[179].nIEC_NM				= 576;		/* Mérések IEC kezdõcíme */
/*  41-09 OK2  -----------------------------------------------------------*/
...
sT[0].sTI[210].nType = TYP_TMOK;
	...
	sT[0].sMOT[210].nIEC_NM				= 694;		/* Mérések IEC kezdõcíme */
/*  34-26 OK2  -----------------------------------------------------------*/
...
sT[0].sTI[216].nType = TYP_TMOK;
	...
	sT[0].sMOT[216].nIEC_NM				= 712;		/* Mérések IEC kezdõcíme */
/*  44-11 OK2  -----------------------------------------------------------*/
...
sT[0].sTI[225].nType = TYP_TMOK;
	...
	sT[0].sMOT[225].nIEC_NM				= 741;		/* Mérések IEC kezdõcíme */
/*  81-23 OK2  -----------------------------------------------------------*/
...
sT[0].sTI[264].nType = TYP_TMOK;
	...
	sT[0].sMOT[264].nIEC_NM				= 865;		/* Mérések IEC kezdõcíme */
/*  30-76   -----------------------------------------------------------*/
sT[0].sTI[265].nType = TYP_TMOK;
	...
	sT[0].sMOT[265].nIEC_NM				= 868;		/* Mérések IEC kezdõcíme */
/*  31-17   -----------------------------------------------------------*/
...
sT[0].sTI[267].nType = TYP_TMOK;
	...
	sT[0].sMOT[267].nIEC_NM				= 874;		/* Mérések IEC kezdõcíme */
/*  31-83   -----------------------------------------------------------*/
sT[0].sTI[268].nType = TYP_TMOK;
	...
	sT[0].sMOT[268].nIEC_NM				= 877;		/* Mérések IEC kezdõcíme */
/*  32-40   -----------------------------------------------------------*/
...
sT[0].sTI[271].nType = TYP_TMOK;
	...
	sT[0].sMOT[271].nIEC_NM				= 886;		/* Mérések IEC kezdõcíme */
/*  35-22   -----------------------------------------------------------*/
sT[0].sTI[272].nType = TYP_TMOK;
	...
	sT[0].sMOT[272].nIEC_NM				= 889;		/* Mérések IEC kezdõcíme */
/*  37-198   -----------------------------------------------------------*/
sT[0].sTI[273].nType = TYP_TMOK;
	...
	sT[0].sMOT[273].nIEC_NM				= 892;		/* Mérések IEC kezdõcíme */
/*  71-78   -----------------------------------------------------------*/
...
sT[0].sTI[304].nType = TYP_TMOK;
	...
	sT[0].sMOT[304].nIEC_NM				= 985;		/* Mérések IEC kezdõcíme */
/*  31-68  -----------------------------------------------------------*/
sT[0].sTI[305].nType = TYP_TMOK;
	...
	sT[0].sMOT[305].nIEC_NM				= 988;		/* Mérések IEC kezdõcíme */
/*  40-76  -----------------------------------------------------------*/
...
sT[0].sTI[311].nType = TYP_TMOK;
	...
	sT[0].sMOT[311].nIEC_NM				= 1006;		/* Mérések IEC kezdõcíme */
/*  80-75  -----------------------------------------------------------*/
